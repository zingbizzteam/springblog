...
export default function BlogsPage() {
  ...
  const performSearch = async (query: string) => {
    try {
      ...
      // For admin search, we'll search through all posts (both published and draft)
      // Since we don't have a dedicated admin search endpoint, we'll use the public search
      // and filter on the frontend, or implement client-side search
  ...
  const handleDelete = async (id: string) => {
    if (window.confirm('Are you sure you want to delete this post?')) {
      try {
        ...
        // Refresh current view (search or regular list)
        if (activeSearch) {
          performSearch(activeSearch);
        } else {
          fetchPosts();
              ...
              <div className="flex items-start justify-between">
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end">
                    <DropdownMenuItem onClick={() => router.push(`/admin/blogs/edit/${post.id}`)}>
